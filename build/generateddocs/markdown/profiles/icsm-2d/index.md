...
# Cadastral Survey 2D (+elevation) basic Profile (Schema)

`icsm.profiles.icsm-2d` *v0.1*

Profile to constrain a 2D implementation of the 3D Cadastre Survey Data Model
...
description: 2D restricted profile Cadastral Survey Data Model
allOf:
...
* YAML version: [schema.yaml](https://surroundaustralia.github.io/3d-csdm-profile-icsm/build/annotated/profiles/icsm-2d/schema.json)
* JSON version: [schema.json](https://surroundaustralia.github.io/3d-csdm-profile-icsm/build/annotated/profiles/icsm-2d/schema.yaml)
...
[context.jsonld](https://surroundaustralia.github.io/3d-csdm-profile-icsm/build/annotated/profiles/icsm-2d/context.jsonld)
