...
# Cadastral Survey Common ICSM Profile (Schema)
...
allOf:
- $ref: https://surroundaustralia.github.io/3d-csdm-common/build/annotated/csdm/features/CSD/schema.yaml
- properties:
    parcels:
      type: array
      items:
          ...
          features:
            ...
            items:
              properties:
                properties:
                  address:
                    $ref: https://surroundaustralia.github.io/3d-csdm-profile-icsm/build/annotated/profiles/datatypes/address/schema.yaml#/$defs/streetAddress
              required:
              - properties
        required:
        - features
...
* YAML version: [schema.yaml](https://surroundaustralia.github.io/3d-csdm-profile-icsm/build/annotated/profiles/common/schema.json)
* JSON version: [schema.json](https://surroundaustralia.github.io/3d-csdm-profile-icsm/build/annotated/profiles/common/schema.yaml)
...
[context.jsonld](https://surroundaustralia.github.io/3d-csdm-profile-icsm/build/annotated/profiles/common/context.jsonld)
